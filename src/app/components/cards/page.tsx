      ...
      <div className="container mx-auto px-4 py-8 sm:py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-8 shadow-lg mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">Basic Cards</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-4">Examples</h3>
                <div className="space-y-4">
                  <div className="bg-white dark:bg-gray-700 rounded-lg p-4 sm:p-6 shadow-md">
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2">Basic Card</h3>
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">
                      This is a simple card component with basic styling and content.
                    </p>
                  </div>
                  <div className="bg-white dark:bg-gray-700 rounded-lg p-4 sm:p-6 shadow-md border border-gray-200 dark:border-gray-600">
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2">Card with Border</h3>
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">
...
<div className="bg-white dark:bg-gray-700 rounded-lg p-6 shadow-md border border-gray-200 dark:border-gray-600">
  ...
  <p className="text-gray-600 dark:text-gray-300">
    This card has a border for better visual separation.
          ...
          {/* Image Cards */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-8 shadow-lg mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">Image Cards</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-4">Examples</h3>
                <div className="space-y-4">
                  <div className="bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden">
                    <div className="w-full h-32 sm:h-48 bg-gradient-to-r from-blue-400 to-purple-500"></div>
                    <div className="p-4 sm:p-6">
                      <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2">Card with Image</h3>
  ...
  <div className="p-6">
    ...
    <button className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200">
      Read More
          ...
          {/* Feature Cards */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-8 shadow-lg mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">Feature Cards</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-4">Examples</h3>
                <div className="space-y-4">
                  <div className="bg-white dark:bg-gray-700 rounded-lg p-4 sm:p-6 shadow-md hover:shadow-lg transition-shadow duration-300">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold text-gray-900 dark:text-white mb-2">Feature Card</h3>
                    <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-4 sm:p-6 text-white">
                    <div className="text-2xl sm:text-3xl font-bold mb-2">1,234</div>
                    <div className="text-sm sm:text-base text-blue-100">Total Users</div>
                  </div>
                  <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-4 sm:p-6 text-white">
                    <div className="text-2xl sm:text-3xl font-bold mb-2">567</div>
                    <div className="text-sm sm:text-base text-green-100">Active Users</div>
                  </div>
                </div>
              </div>
              <div>
...
<div className="grid grid-cols-2 gap-4">
  ...
  <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-6 text-white">
    ...
    <div className="text-green-100">Active Users</div>
          ...
          {/* Testimonial Cards */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-8 shadow-lg mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">Testimonial Cards</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              <div>
                <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-4">Examples</h3>
                <div className="space-y-4">
                  <div className="bg-white dark:bg-gray-700 rounded-lg p-4 sm:p-6 shadow-md">
                    <div className="flex items-center mb-4">
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gray-300 dark:bg-gray-600 rounded-full mr-3 sm:mr-4"></div>
                      <div>
                        <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">John Doe</div>
                        <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300">CEO, Company</div>
                      </div>
                    </div>
  ...
  <p className="text-gray-600 dark:text-gray-300 italic">
    &ldquo;This is an amazing product that has transformed our workflow completely.&rdquo;
          ...
          <div className="text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-6 sm:p-12 text-white">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6">Ready to Use These Cards?</h2>
