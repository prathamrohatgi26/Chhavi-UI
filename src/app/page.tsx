      ...
      <div className="container mx-auto px-4 py-8 sm:py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-left sm:text-center mb-8 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto px-0 sm:px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-20">
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/components"
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-sm sm:text-base"
                >
                  Explore Components
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-semibold rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 text-sm sm:text-base"
                >
                  View on GitHub
                </a>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-20">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4">Lightning Fast</h3>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4">Beautiful Design</h3>
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4">Accessible</h3>
              <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300">
